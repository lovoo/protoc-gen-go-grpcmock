...
func TestGetFeature(t *testing.T) {
	...
	pegomock.When(m.GetFeature(ctx, req)).ThenReturn(res, nil)
...
func TestListFeatures(t *testing.T) {
	...
	pegomock.When(res.Recv()).ThenReturn(feat, nil)
	pegomock.When(m.ListFeatures(ctx, req)).ThenReturn(res, nil)
...
func TestRecordRoute(t *testing.T) {
	...
	// Set up the expectations.
	pegomock.When(res.Send(AnyPtrToRouteguidePoint())).ThenReturn(nil)
	pegomock.When(res.CloseAndRecv()).ThenReturn(routs, nil)
	pegomock.When(m.RecordRoute(ctx)).ThenReturn(res, nil)
...
func TestRouteChat(t *testing.T) {
	...
	// Set up the expectations.
	pegomock.When(res.Send(AnyPtrToRouteguideRouteNote())).ThenReturn(nil)
	pegomock.When(res.Recv()).ThenReturn(routn, nil)
	pegomock.When(m.RouteChat(ctx)).ThenReturn(res, nil)
